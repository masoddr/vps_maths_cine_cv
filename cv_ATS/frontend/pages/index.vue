  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center space-x-4">
            <!-- GitHub Link -->
            <a 
              href="https://github.com/masoddr/cv_ats"
              target="_blank"
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section class="py-12 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 class="text-2xl font-semibold text-center text-gray-800 dark:text-white mb-8">
            Développé avec
          </h2>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center justify-items-center">
            <div class="flex flex-col items-center">
              ...
              />
              <span class="mt-2 text-sm text-gray-600 dark:text-gray-400">FastAPI</span>
            </div>
            ...
            <div class="flex flex-col items-center">
              <img 
                ...
                class="h-12 dark:invert"
              />
              <span class="mt-2 text-sm text-gray-600 dark:text-gray-400">Nuxt.js</span>
            </div>
            ...
            <div class="flex flex-col items-center">
              <img 
                ...
                class="h-12"
              />
              <span class="mt-2 text-sm text-gray-600 dark:text-gray-400">Tailwind CSS</span>
            </div>
          </div>
        </div>
      </section>
